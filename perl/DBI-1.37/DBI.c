...
XS(XS_DBI__clone_dbis)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: DBI::_clone_dbis()");
    {
#line 3108 "DBI.xs"
    dPERINTERP;
    dbi_bootinit(DBIS);
...
XS(XS_DBI_dbi_time)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: DBI::dbi_time()");
    {
	double	RETVAL;
	dXSTARG;
...
XS(XS_DBI_dbi_profile)
{
    dXSARGS;
    if (items != 5)
	Perl_croak(aTHX_ "Usage: DBI::dbi_profile(h, statement, method, t1, t2)");
    {
	SV *	h = ST(0);
	SV *	statement = ST(1);
	SV *	method = ST(2);
	double	t1 = (double)SvNV(ST(3));
	double	t2 = (double)SvNV(ST(4));
	SV *	RETVAL;
#line 3308 "DBI.xs"
    D_imp_xxh(h);
    STRLEN lna = 0;
...
XS(XS_DBI_dbi_profile_merge); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI_dbi_profile_merge)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: DBI::dbi_profile_merge(dest, ...)");
    {
	SV *	dest = ST(0);
	SV *	RETVAL;
#line 3324 "DBI.xs"
...
XS(XS_DBD_____db_take_imp_data)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: DBD::_::db::take_imp_data(h)");
    {
	SV *	h = ST(0);
#line 3427 "DBI.xs"
...
XS(boot_DBI)
{
...

    {
        ...
        newXS("DBI::dbi_profile_merge", XS_DBI_dbi_profile_merge, file);
